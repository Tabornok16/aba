...
class ReportVerifiedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Your report has been verified by our staff.')
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'message' => 'Your report has been verified by our staff.',
